...
data("Smarket")
head(Smarket)
#percentage returns for S&P500 stock index (2001 - 2005)
names(Smarket)
...
#cor() function produces a matrix containing all the pairwise correlations among predictors in dataset
...
#e.g. to pick out submatrix of stock market data set (corresponding only to dates before 2005)
#Smarket[train,]
